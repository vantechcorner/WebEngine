<?php
/**
 * Install WebEngine Tables without Foreign Keys (Initial Version)
 */

echo "<h1>Install WebEngine Tables (No Foreign Keys)</h1>\n";
echo "<hr>\n";
...
try {
    ...
    // Define tables to create WITHOUT foreign key constraints
    $tables = [
        'webengine_news' => "
    ...
    echo "<h2>🔧 Creating Tables (Without Foreign Keys)</h2>\n";
    $success_count = 0;
    $error_count = 0;
    ...
    if ($error_count == 0) {
        ...
        echo "<p><strong>Note:</strong> Foreign key constraints were not added to avoid dependency issues.</p>\n";
        echo "<p><strong>Next Steps:</strong></p>\n";
        echo "<ol>\n";
        echo "<li><a href='check_openmu_columns.php'>Check OpenMU column names</a></li>\n";
